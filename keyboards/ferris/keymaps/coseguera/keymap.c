...
[0] = LAYOUT(
    ...
    SFT_T(KC_Z), CTL_T(KC_X), CTL_T(KC_C), GUI_T(KC_V), GUI_T(KC_B),   GUI_T(KC_N),   GUI_T(KC_M), CTL_T(KC_COMM), CTL_T(KC_DOT), RSFT_T(KC_SLSH),
                                           BKTS,        LT(2, KC_ENT), LT(1, KC_SPC), KC_BSPC
),
[1] = LAYOUT(
    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
    KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,
    KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX,
                               BRCS,    _______, _______, _______
),
[2] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, KC_F11,  KC_F12,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  XXXXXXX,
